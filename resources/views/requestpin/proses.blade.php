  ...
  <div class="row">
    <div class="col-md-12">
      ...
      @endif
        ...
        <div class="card">
            <div class="card-header">Info Request yang anda input</div>
                <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">Info Bantuan Yang anda ditawarkan Helper</div>
                <div class="card-body">
                    <b>Deskripsi Bantuan: </b> {{$data_helper->DESKRIPSI}} <br>
                    <b>Harga Bantuan: </b> Rp. {{$data_helper->HARGA}} <br>
                    @if($data_helper->FILE != NULL)
                        <b>File: </b><a class="btn btn-success" href={{asset('storage/'.$data_helper->FILE)}}>DOWNLOAD</a>
                    @endif
                </div>
        </div>
        <br>

        <center><a href="{{route('reqpin.finish', ['id'=>$data_helper->id])}}" class="btn btn-primary btn-sm">Selesai</a></center>
